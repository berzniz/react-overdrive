(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("Overdrive", ["react", "react-dom"], factory);
	else if(typeof exports === 'object')
		exports["Overdrive"] = factory(require("react"), require("react-dom"));
	else
		root["Overdrive"] = factory(root["React"], root["ReactDOM"]);
...
var Overdrive = function (_React$Component) {
  (0, _inherits3.default)(Overdrive, _React$Component);

  function Overdrive(props) {
    (0, _classCallCheck3.default)(this, Overdrive);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Overdrive.__proto__ || (0, _getPrototypeOf2.default)(Overdrive)).call(this, props));

    _this.state = {
      loading: true
    };
    _this.animateEnd = _this.animateEnd.bind(_this);
    return _this;
  }

  (0, _createClass3.default)(Overdrive, [{
    key: 'animate',
    value: function animate(prevPosition, prevElement) {
      var _this2 = this;
      ...
      var nextPosition = this.getPosition(true);
      var noTransform = 'scaleX(1) scaleY(1) translateX(0px) translateY(0px)';
      var targetScaleX = prevPosition.width / nextPosition.width;
      var targetScaleY = prevPosition.height / nextPosition.height;
      var targetTranslateX = prevPosition.left - nextPosition.left;
      var targetTranslateY = prevPosition.top - nextPosition.top;

      if (targetScaleX === 1 && targetScaleY === 1 && targetTranslateX === 0 && targetTranslateY === 0) {
        return;
      }
      ...
      var sourceStart = _react2.default.cloneElement(prevElement, {
        key: '1',
        style: (0, _prefix2.default)((0, _extends3.default)({}, transition, prevPosition, {
          opacity: 1,
          transform: noTransform
        }))
      });

      var sourceEnd = _react2.default.cloneElement(prevElement, {
        key: '1',
        style: (0, _prefix2.default)((0, _extends3.default)({}, transition, prevPosition, {
      ...
      var targetStart = _react2.default.cloneElement(this.props.children, {
        key: '2',
        style: (0, _prefix2.default)((0, _extends3.default)({}, transition, nextPosition, {
      ...
      var targetEnd = _react2.default.cloneElement(this.props.children, {
        key: '2',
        style: (0, _prefix2.default)((0, _extends3.default)({}, transition, nextPosition, {
          opacity: 1,
          transform: noTransform
      ...
      this.animationTimeout = setTimeout(function () {
        renderSubtreeIntoContainer(_this2, end, bodyElement);
        _this2.animationTimeout = setTimeout(_this2.animateEnd, duration);
      }, 0);
    }
  }, {
    key: 'animateEnd',
    ...
    value: function onHide() {
      ...
      var prevElement = _react2.default.cloneElement(this.props.children);
    ...
    value: function onShow() {
      ...
      if (components[id]) {
        var _components$id = components[id],
            ...
            prevElement = _components$id.prevElement;
    ...
    key: 'getPosition',
    value: function getPosition(addOffset) {
    ...
    value: function render() {
      ...
      var _props3 = this.props,
          ...
          animationDelay = _props3.animationDelay,
          _props3$style = _props3.style,
          style = _props3$style === undefined ? {} : _props3$style,
          children = _props3.children,
          element = _props3.element,
          rest = (0, _objectWithoutProperties3.default)(_props3, ['id', 'duration', 'animationDelay', 'style', 'children', 'element']);
      ...
      return _react2.default.createElement(element, (0, _extends3.default)({
        ref: function ref(c) {
          return _this3.element = c && c.firstChild;
        },
        style: newStyle
      }, rest), onlyChild);
    }
...
var prefix = function prefix(styles) {
  var prefixedStyles = {};
  var styleProperties = (0, _keys2.default)(styles || {});
  styleProperties.forEach(function (property) {
    if (propertiesToPrefix[property]) {
      var prefixedProperty = webkitPrefix + property[0].toUpperCase() + property.slice(1);
...
var _overdrive = __webpack_require__(48);

var _overdrive2 = _interopRequireDefault(_overdrive);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _overdrive2.default;
